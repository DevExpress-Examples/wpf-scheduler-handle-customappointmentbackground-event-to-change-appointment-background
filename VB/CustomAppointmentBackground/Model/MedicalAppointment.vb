...
Namespace CustomAppointmentBackground
    ...
    Public Class MedicalAppointment
        ...
        Friend Shared Function Create(ByVal StartTime As Date, ByVal EndTime As Date, ByVal DoctorId As Integer, ByVal Notes As String, ByVal Location As String, ByVal PatientName As String, ByVal InsuranceNumber As String, ByVal FirstVisit As Boolean, ByVal AllDay As Boolean) As MedicalAppointment
