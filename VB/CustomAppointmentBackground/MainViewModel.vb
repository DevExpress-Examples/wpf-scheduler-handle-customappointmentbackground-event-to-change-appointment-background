...
Namespace CustomAppointmentBackground
    ...
    Public Class MainViewModel
        ...
        Private Sub CreateMedicalAppointments()
            ...
            Appointments.Add(MedicalAppointment.Create(StartTime:=Date.Now.Date.AddHours(10), EndTime:=Date.Now.Date.AddHours(11), DoctorId:=1, Notes:="", Location:="101", PatientName:="Dave Murrel", InsuranceNumber:="111111111", FirstVisit:=True, AllDay:=False))
            Appointments.Add(MedicalAppointment.Create(StartTime:=Date.Now.Date.AddHours(11), EndTime:=Date.Now.Date.AddHours(12), DoctorId:=2, Notes:="", Location:="", PatientName:="Day-off", InsuranceNumber:="111111111", FirstVisit:=True, AllDay:=True))
        End Sub
    End Class
End Namespace
